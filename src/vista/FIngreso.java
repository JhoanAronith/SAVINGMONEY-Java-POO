...
public class FIngreso extends javax.swing.JFrame {
    ...
    public FIngreso() {
        ...
        this.setTitle("Registrar Ingresos");
    }
    ...
    private void initComponents() {
        ...
        jPanel2.add(btnIngreso, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 10, -1, -1));
        ...
        jtblIngresos.setBackground(new java.awt.Color(171, 171, 171));
        ...
        jLabel2.setText("REGISTRA TUS INGRESOS");
        ...
        jLabel4.setText("RESUMEN DE INGRESOS");
        ...
        cbxCategoria.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Salario", "Inversiones", "Ahorros", "Alquileres", "Ventas", "Extras" }));
        ...
        jPanel1.add(btnEditar, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 440, 110, -1));
    ...
    public javax.swing.JTable jtblIngresos;
